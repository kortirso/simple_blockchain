RSpec.describe User, type: :model do
  ...
  it { should have_one(:doctor_job).class_name('Doctor') }
  ...
  it 'should be valid with email and password' do
    user = User.new(name: 'Имя', email: 'example@gmail.com', password: 'password')
  ...
  it 'should be invalid with a duplicate email' do
    User.create(name: 'Имя', email: 'example@gmail.com', password: 'password')
    user = User.new(name: 'Имя', email: 'example@gmail.com', password: 'password')
    user.valid?
